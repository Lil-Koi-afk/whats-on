...
const translations = {
    ...
    de: {
        ...
        hero_subtitle: "Finde Festivals, Konzerte, Märkte und lokale Events überall auf der Welt",
        where: "Wo",
        search_placeholder: "Suche Städte, Regionen, Inseln...",
        radius: "Radius",
        exact: "Genau",
        when: "Wann",
        search: "Suchen",
        ...
        things_anytime: "Aktivitäten für jederzeit",
    ...
    es: {
        hero_title: "Descubre qué está pasando a tu alrededor",
        ...
        try_adjusting: "Intenta ajustar tus criterios de búsqueda o ampliar el radio",
    ...
    it: {
        ...
        where: "Dove",
        search_placeholder: "Cerca città, regioni, isole...",
        radius: "Raggio",
        exact: "Esatto",
        when: "Quando",
        search: "Cerca",
...
function updateDateDisplay() {
    if (selectedStartDate && selectedEndDate) {
        ...
        dateDisplayText.textContent = `${startStr} – ${endStr}`;
...
function applyLanguage(lang) {
    ...
    currentFlagSpan.textContent = flags[lang] || '🇬🇧';
...
function translateTime(time) {
    ...
    if (timeLower === 'all day' || timeLower === 'ganztägig') return t('all_day');
...
async function performSearch() {
    ...
    resultsSubtitle.textContent = `${formatDisplayDate(startDate)} – ${formatDisplayDate(endDate)}${radius > 0 ? ` • ${radius} km` : ''}`;
